...
"$PYTHON" "$FUNCTIONAL_ROOT/tests/test_mx_exact_chunked.py"
"$PYTHON" "$FUNCTIONAL_ROOT/tests/test_mxfp_weight_cache_compact.py"
"$PYTHON" "$FUNCTIONAL_ROOT/tests/test_ppl_tail_logits_loss.py"
...
"$PYTHON" "$FUNCTIONAL_ROOT/tools/probe_mxfp_memory.py" \
